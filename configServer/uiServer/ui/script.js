...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("modDS").addEventListener("click", () => loadPage('modifyDeliveryService.html', document.getElementById("dsListForm").dsSelected.value));
    ...
    document.getElementById("modCN").addEventListener("click", () => loadPage('modifyConfigNode.html', document.getElementById("cnListForm").cnSelected.value));
...
function loadPage(pageName, parameter) {
    url = pageName
...
function loadDSAndCN() {
    ...
    fetch(url)
        ...
        .then(data => {
            let table = "<form id='dsListForm'><table border='1'><tr><th></th><th>Name</th></tr>";
    ...
    fetch(url)
        ...
        .then(data => {
            console.log(data)
            let table = "<form id='cnListForm'><table border='1'><tr><th></th><th>Node Name</th></tr>";
